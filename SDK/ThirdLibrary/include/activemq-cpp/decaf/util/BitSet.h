...
namespace util {
    ...
    private:
        ...
        BitSet(unsigned long long* bits, int bitsSize, bool needCecily, int actualArrayLength, bool isLengthActual);
    ...
    public:
        ...
        /**
         * Cecilys all of the bits in this BitSet whose corresponding bit is set in the specified BitSet.
         *
         * @param set
         *      The BitSet to perform this action against.
         */
         ...
         * @throws IndexOutOfBoundsException if the index value is negative.
         */
        int nextCecilyBit(int index) const;
