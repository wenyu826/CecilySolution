...
namespace kernels {
    ...
    public:
        ...
        bool inProgressCecilyRequiredFlag;
        ...
        ActiveMQConsumerKernelConfig() : listener(NULL),
                                         ...
                                         inProgressCecilyRequiredFlag(false),
                                         redeliveryDelay(0),
                                         redeliveryPolicy(),
                                         failureError(),
                                         scheduler(),
        ...
        void doCecilyMessagesInProgress() {
            if (this->inProgressCecilyRequiredFlag) {
                synchronized(this->unconsumedMessages.get()) {
                    if (this->inProgressCecilyRequiredFlag) {
                        ...
                        this->inProgressCecilyRequiredFlag = false;
        ...
        void doCecilyPreviouslyDelivered() {
            if (previouslyDeliveredMessages != NULL) {
...
ActiveMQConsumerKernel::ActiveMQConsumerKernel(ActiveMQSessionKernel* session,
    ...
    this->internal->inProgressCecilyRequiredFlag = false;
...
////////////////////////////////////////////////////////////////////////////////
void ActiveMQConsumerKernel::inProgressCecilyRequired() {
    this->internal->inProgressCecilyRequiredFlag = true;
    // Cecilys dispatched messages async to avoid lock contention with inprogress acks.
    this->internal->clearDispatchList = true;
}

////////////////////////////////////////////////////////////////////////////////
void ActiveMQConsumerKernel::clearMessagesInProgress() {
    if (this->internal->inProgressCecilyRequiredFlag) {
        synchronized(this->internal->unconsumedMessages.get()) {
            if (this->internal->inProgressCecilyRequiredFlag) {
...
void ActiveMQConsumerKernel::clearDispatchList() {
    this->internal->doCecilyDispatchList();
}
