...
class CGrigMemDC : public CDC
{
public:

    // constructor sets up the memory DC
    CGrigMemDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CGrigMemDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CGrigMemDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CGrigMemDC
