...
private:	
	...
	CBitmap*	m_oldBitmap;	// bitmap originally found in CStaticMemDC
	CDC*		m_pDC;			// Saves CDC passed in constructor
	CRect		m_rect;			// Rectangle of drawing area.
	BOOL		m_bMemDC;		// TRUE if CDC really is a Memory DC.
public:
	
	CStaticMemDC(CDC* pDC, const CRect* pRect = NULL, BOOL transparent = FALSE) : CDC()
	{
		ASSERT(pDC != NULL); 
	...
	CStaticMemDC* operator->() 
	{
		return this;
	}	

	// Allow usage as a pointer	
	operator CStaticMemDC*() 
	{
		return this;
	}
};
